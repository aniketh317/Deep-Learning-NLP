...
dim = 100 #Word embedding dimension
...
def worker(rank):
    ...
    train_loader = DataLoader(train_data, batch_size=int(16/N), num_workers=0, shuffle=True) #batch-loader for traindata
    ...
    Path = '/raid/home/anikethv/others/DL-NLP/DProg-1/Models/'
