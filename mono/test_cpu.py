...
import pickle
import torch
from mono.model.bert import ENBertReverseDict, ENRobertaReverseDict
...
model_lkp = {}
model_lkp['bert'] = ['./save_models/best_ENBERTcpu.pt', BertTokenizer.from_pretrained('bert-base-uncased'),'bert-base-uncased']
...
if model_sel == 'bert':
    model = ENBertReverseDict(pre_name, word2bpes, pad_id=pad_id,number_word_in_train=data_bundle.number_word_in_train)
else:
