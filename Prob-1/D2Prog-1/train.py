...
def train(model, loss_criterion, rank, num_proc, train_loader, validation_loader=None, optimizer=None, epochs_range=100, min_delta=0, patience=10,
          verbose=False):
    ...
    #Gather tensors from all processes and cobine them using the default ReduceOP = sum
    dist.all_reduce(valid_loss)
    valid_loss = valid_loss/num_proc
