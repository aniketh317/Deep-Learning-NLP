...
def model_train(model,train_data, criterion, optimiser, collate_fn, embed=None, heads=None, device = torch.device('cpu'), epoch_l=300, 
    ...
    while epoch <= epoch_l and not stop:
        ...
        if verbose:
            print('Embed:{}, Num-Heads:{} -- Epoch number:{}, training loss:{}, validation accuracy:{}'.format(embed, heads, epoch+epoch_s, loss, vacc))
